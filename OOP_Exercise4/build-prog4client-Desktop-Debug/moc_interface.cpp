...
#include "../prog4client/interface.h"
...
QT_MOC_LITERAL(1, 11, 7), // "request"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 6), // "answer"
QT_MOC_LITERAL(4, 27, 11) // "formRequest"

    },
    "TInterface\0request\0\0answer\0formRequest"
};
...
void TInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->request((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->answer((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TInterface::request)) {
                *result = 0;
                return;
            }
        }
