...
QT_MOC_LITERAL(1, 11, 11), // "ChangeGraph"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 6), // "TGraph"
QT_MOC_LITERAL(4, 31, 10), // "OpenCanvas"
QT_MOC_LITERAL(5, 42, 8), // "OpenFile"
QT_MOC_LITERAL(6, 51, 11) // "CloseCanvas"

    },
    "TInterface\0ChangeGraph\0\0TGraph\0"
    "OpenCanvas\0OpenFile\0CloseCanvas"
};
...
void TInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ChangeGraph((*reinterpret_cast< TGraph(*)>(_a[1]))); break;
        case 1: _t->OpenCanvas(); break;
        case 2: _t->OpenFile(); break;
        case 3: _t->CloseCanvas(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TInterface::*)(TGraph );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TInterface::ChangeGraph)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TInterface::ChangeGraph(TGraph _t1)
{
