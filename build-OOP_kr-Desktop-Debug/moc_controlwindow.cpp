...
#include "../OOP_kr/controlwindow.h"
...
QT_MOC_LITERAL(3, 24, 16), // "sendControlEvent"
QT_MOC_LITERAL(4, 41, 6), // "TEvent"
QT_MOC_LITERAL(5, 48, 13) // "ControlEvents"

    },
    "TControlwindow\0closing\0\0sendControlEvent\0"
    "TEvent\0ControlEvents"
};
...
void TControlwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendControlEvent((*reinterpret_cast< TEvent(*)>(_a[1]))); break;
        ...
        {
            using _t = void (TControlwindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TControlwindow::closing)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TControlwindow::*)(TEvent );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TControlwindow::sendControlEvent)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TControlwindow::closing()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void TControlwindow::sendControlEvent(TEvent _t1)
{
